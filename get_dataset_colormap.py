...
def create_label_colormap(dataset=_PQR_SEG_INFORMATION):
  ...
  elif dataset == _PQR_SEG_INFORMATION:
    return create_pqr_label_colormap()
  else:
    raise ValueError('Unsupported dataset.')


def label_to_color_image(label, dataset=_PQR_SEG_INFORMATION):
